function Line(n,o1,o2,c,l,t,sc){
    ...
    this.type = t;
    this.ctx = c;
    this.level = l; //1-4, corresponds to level.num
    this.obj1 = o1;
    this.obj2 = o2;
    ...
    //NOTE: getPoint and getLineXY could be refactored 
    ...
    function drawDoubleArrow(ctx,p1,p2,t){  //sb = sourceBtn, db = destinationBtn
        ...
        */
        ...
        //draw +/- symbols
        var plusXY = findPerpendicularPoint(line2.p1,line2.p2,"line2",0.8,26); //getLineXY(line2.p1,line2.p2,0.875);
        var minusXY = findPerpendicularPoint(line1.p1,line1.p2,"line1",0.2,26); //getLineXY(line1.p1,line1.p2,0.125);
        var textHeight = 14;
        var textWidth = 0;
