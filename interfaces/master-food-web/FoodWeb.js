...
function FoodWeb(){
    ...
    */
    ...
    function setupButtons(){
        ...
        saveBtn = new ImageTextButton("Save", btnX, btnY, btnWidth, btnHeight, ctx, trophicBox1Colour, "#FFFFFF", "300 8pt 'Roboto'", 28, background);
    ...
    */
    ...
    function getDrawing(){
        ...
        message = message.slice(0, -2);
        currentDrawing = { browserH: preScaledHeight, browserW: preScaledWidth, nodes: nodes, links: links, badges: groupBadges };
