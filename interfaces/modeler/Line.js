function Line(n,o1,o2,c,l,t,d,sc,bg){
    this.datalog = d;
    this.name=n;
    this.type = t;
    this.ctx = c;
    ...
    if( this.level > 1 ){
        if( this.type == "eatenby" ){
            ...
            this.sourceBtn = new ToggleButton("source", "minus", 0, 0, this.ctx, this.backgroundColour);
            this.destinationBtn = new ToggleButton("destination", "plus", 0, 0, this.ctx, this.backgroundColour);
        } else if ( this.type == "competition" ){
            this.sourceBtn = new ToggleButton("source", "minus", 0, 0, this.ctx, this.backgroundColour);
            this.destinationBtn = new ToggleButton("destination", "minus", 0, 0, this.ctx, this.backgroundColour);
            ...
            this.sourceBtn = new ToggleButton("source", "plus", 0, 0, this.ctx, this.backgroundColour);
            this.destinationBtn = new ToggleButton("destination", "minus", 0, 0, this.ctx, this.backgroundColour);
