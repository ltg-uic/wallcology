...
"undefined" == typeof WeakMap && !function () {
    ...
    function T(e, t, n, r) {
        ...
        var o = q(document.createEvent(t)), i = we[t], a = [n];
    ...
    var ce = S("UIEvent", y), ue = S("CustomEvent", y), le = {
        get relatedTarget() {
            var e = Z.get(this);
            return void 0 !== e ? e : V(q(this).relatedTarget)
        }
    }, pe = k({initMouseEvent: M("initMouseEvent", 14)}, le), de = k({initFocusEvent: M("initFocusEvent", 5)}, le), fe = S("MouseEvent", ce, pe), he = S("FocusEvent", ce, de), we = Object.create(null), me = function () {
        try {
    ...
    var be = window.EventTarget, ye = ["addEventListener", "removeEventListener", "dispatchEvent"];
    ...
    function S(e) {
        j(e instanceof V), M.call(this, e), this.parentNode_ = void 0, this.firstChild_ = void 0, this.lastChild_ = void 0, this.nextSibling_ = void 0, this.previousSibling_ = void 0, this.treeScope_ = void 0
    }

    var M = e.wrappers.EventTarget, T = e.wrappers.NodeList, O = e.TreeScope, j = e.assert, N = e.defineWrapGetter, L = e.enqueueMutation, _ = e.getTreeScope, C = e.isWrapper, D = e.mixin, H = e.registerTransientObservers, x = e.registerWrapper, R = e.setTreeScope, P = e.unsafeUnwrap, W = e.unwrap, A = e.unwrapIfNeeded, I = e.wrap, k = e.wrapIfNeeded, F = e.wrappers, B = !1, U = document.importNode, q = window.Node.prototype.cloneNode, V = window.Node, G = window.DocumentFragment, z = (V.prototype.appendChild, V.prototype.compareDocumentPosition), X = V.prototype.isEqualNode, K = V.prototype.insertBefore, Y = V.prototype.removeChild, $ = V.prototype.replaceChild, Z = /Trident|Edge/.test(navigator.userAgent), J = Z ? function (e, t) {
        try {
            Y.call(e, t)
        } catch (n) {
    ...
    S.prototype = Object.create(M.prototype), D(S.prototype, {
        appendChild: function (e) {
            ...
            t(e);
            var r;
            n ? C(n) ? r = W(n) : (r = n, n = I(r)) : (n = null, r = null), n && j(n.parentNode === this);
    ...
    function h(n, r, o, i, a) {
        var s, c = v(this), u = g(this).root;
        if (u instanceof e.wrappers.ShadowRoot)return p(this, r, o, n, i, a);
        if (c instanceof L)s = N.call(c, i, a); else {
            if (!(c instanceof _))return p(this, r, o, n, i, a);
            s = j.call(c, i, a)
        }
        return t(s, r, o, !1)
    ...
    function E(e) {
        return e instanceof j || e instanceof N
    }
    ...
    B.equals = function (e, t) {
        ...
        render: function (e) {
            ...
            if (!(e instanceof N))if (e instanceof j) {
                var n = e;
    ...
    }, j.prototype.getDistributedNodes = N.prototype.getDistributedNodes = function () {
        return s(), i(this)
    }, O.prototype.getDestinationInsertionPoints = function () {
        return s(), g(this) || []
    }, j.prototype.nodeIsInserted_ = N.prototype.nodeIsInserted_ = function () {
    ...
    function n(e) {
        ...
        t.prototype[e] = function () {
            return L(n.apply(j(this), arguments))
        }
    }

    function r(e, t) {
        D.call(j(t), N(e)), o(e, t)
    }
    ...
    if (t.prototype.createTreeWalker = function (e, t, n, r) {
            ...
            return n && (n.acceptNode && "function" == typeof n.acceptNode ? o = {
                acceptNode: function (e) {
                    return n.acceptNode(L(e))
                }
            } : "function" == typeof n && (o = function (e) {
                return n(L(e))
            })), new R(x.call(N(this), N(e), t, o, r))
        ...
        t.prototype.registerElement = function (t, n) {
            ...
            ["createdCallback", "attachedCallback", "detachedCallback", "attributeChangedCallback"].forEach(function (e) {
                var t = o[e];
                t && (u[e] = function () {
                    L(this)instanceof r || T(this), t.apply(L(this), arguments)
                })
            });
            var p = {prototype: u};
    ...
    b([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), b([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], y), b([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "createTreeWalker", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), E(t.prototype, u), E(t.prototype, p), E(t.prototype, f), E(t.prototype, {
        get implementation() {
            var e = C.get(this);
            return e ? e : (e = new a(N(this).implementation), C.set(this, e), e)
        }, get defaultView() {
            return L(N(this).defaultView)
        }
