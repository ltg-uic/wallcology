...
window.WebComponents = window.WebComponents || {}, function (e) {
    ...
    function w(t, n, r, o) {
        for (var i = W(t), a = 0; a < i.length; a++) {
            ...
            if ("polymerBlackList_" !== s && !(s in n || t.polymerBlackList_ && t.polymerBlackList_[s])) {
                ...
                var c, l, d = m(t, s);
                if (r && "function" == typeof d.value)n[s] = f(s); else {
                    var w = u(s);
    ...
    function f(t, n) {
        ...
        return ne.set(t, o), m(t, o, a, i) && w(t, o, a, i) && v(t, o, a, i), J.set(t, re), X["delete"](t, null), Y["delete"](t), t.defaultPrevented
    }
    ...
    function T(e, t, n, r) {
        ...
        var o = B(document.createEvent(t)), i = me[t], a = [n];
    ...
    var ce = _("UIEvent", y), le = _("CustomEvent", y), ue = {
        get relatedTarget() {
            var e = Z.get(this);
            return void 0 !== e ? e : V(B(this).relatedTarget)
        }
    }, de = W({initMouseEvent: S("initMouseEvent", 14)}, ue), pe = W({initFocusEvent: S("initFocusEvent", 5)}, ue), he = _("MouseEvent", ce, de), fe = _("FocusEvent", ce, pe), me = Object.create(null), we = function () {
        try {
    ...
    _.prototype = Object.create(S.prototype), D(_.prototype, {
        appendChild: function (e) {
            ...
            if (o = c ? a(e) : i(e, this, s, n), c)h(this, e), w(this), Y.call(I(this), P(e), r); else {
            ...
            return p ? s = a(e) : (c === e && (c = e.nextSibling), s = i(e, this, l, c)), p ? (h(this, e), w(this), X.call(I(this), P(e), o)) : (this.firstChild === r && (this.firstChild_ = s[0]), this.lastChild === r && (this.lastChild_ = s[s.length - 1]), r.previousSibling_ = r.nextSibling_ = r.parentNode_ = void 0, o.parentNode && X.call(o.parentNode, m(this, s), o)), N(this, "childList", {
                addedNodes: s,
                removedNodes: n(r),
                nextSibling: c,
                previousSibling: l
    ...
    r.prototype = {
        addNodes: function (e) {
            ...
            return this.cache[e] ? (this.onload(e, t, this.cache[e]),
