...
"undefined" == typeof WeakMap && !function () {
        ...
        enqueue: function (e) {
            ...
            switch (e.stopImmediatePropagation(), e.type) {
                case"DOMAttrModified":
                    var t = e.attrName, r = e.relatedNode.namespaceURI, n = e.target, o = new c("attributes", n);
                ...
                case"DOMCharacterDataModified":
                    var n = e.target, o = c("characterData", n), a = e.prevValue;
                    i(n, function (e) {
    ...
    function i(e, t) {
        ...
        if (c)for (var h, m = 0; c > m && (h = s[m]); m++)a(h) ? (d++, r()) : (h.addEventListener("load", n), h.addEventListener("error", i)); else r()
    }
    ...
    function s(e) {
        for (var t, r = 0, n = e.length; n > r && (t = e[r]); r++)d(t) && c(t)
    }
    ...
    var v = /Trident|Edge/.test(navigator.userAgent), b = v ? "complete" : "interactive", g = "readystatechange";
    l && (new MutationObserver(function (e) {
        for (var t, r = 0, n = e.length; n > r && (t = e[r]); r++)t.addedNodes && s(t.addedNodes)
    }).observe(document.head, {childList: !0}), function () {
        if ("loading" === document.readyState)for (var e, t = document.querySelectorAll("link[rel=import]"), r = 0, n = t.length; n > r && (e = t[r]); r++)c(e)
    }()), t(function (e) {
    ...
    var t = /(url\()([^)]*)(\))/g, r = /(@import[\s]+(?!url\())([^;]*)(;)/g, n = {
        resolveUrlsInStyle: function (e, t) {
            var r = e.ownerDocument, n = r.createElement("a");
    ...
    var t = {
        async: !0, ok: function (e) {
            ...
            return (e.flags.debug || e.flags.bust) && (r += "?" + Math.random()), i.open("GET", r, t.async), i.addEventListener("readystatechange", function (e) {
                if (4 === i.readyState) {
                    var r = i.getResponseHeader("Location"), a = null;
                    if (r)var a = "/" === r.substr(0, 1) ? location.origin + r : r;
    ...
    n.prototype = {
        addNodes: function (e) {
            ...
            if (r.load && console.log("fetch", e, n), e)if (e.match(/^data:/)) {
            ...
            this.cache[e] = n;
            for (var i, a = this.pending[e], s = 0, d = a.length; d > s && (i = a[s]); s++)this.onload(e, i, n, r, o), this.tail();
            this.pending[e] = null
        }, tail: function () {
    ...
    t.prototype = {
        handler: function (e) {
            for (var t, r = 0, n = e.length; n > r && (t = e[r]); r++)"childList" === t.type && t.addedNodes.length && this.addedNodes(t.addedNodes)
        }, addedNodes: function (e) {
            this.addCallback && this.addCallback(e);
            for (var t, r = 0, n = e.length; n > r && (t = e[r]); r++)t.children && t.children.length && this.addedNodes(t.children)
        }, observe: function (e) {
    ...
    function o(e) {
        ...
        var r = e.ownerDocument.baseURI, n = t.__importedScripts ? "-" + t.__importedScripts : "";
    ...
    var a = e.path, s = e.rootDocument, d = e.flags, c = e.isIE, u = e.IMPORT_LINK_TYPE, l = "link[rel=" + u + "]", h = {
        ...
        nextToParseInDoc: function (e, r) {
            if (e && this._mayParse.indexOf(e) < 0) {
                ...
                for (var n, o = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = o.length; a > i && (n = o[i]); i++)if (!this.isParsed(n))return this.hasResource(n) ? t(n) ? this.nextToParseInDoc(n["import"], n) : n : void 0
            }
            return r
        },
    ...
    var t = e.parser, r = e.importer, n = {
        added: function (e) {
            for (var n, o, i, a, s = 0, d = e.length; d > s && (a = e[s]); s++)n || (n = a.ownerDocument, o = t.isParsed(n)), i = this.shouldLoadNode(a), i && r.loadNode(a), this.shouldParseNode(a) && o && t.parseDynamic(a, i)
    ...
    var r = e.initializeModules, n = e.isIE;
    if (!e.useNative) {
